...
import { WebNotificationComponent } from 'app/entities/web-notification/web-notification.component';
...
describe('Component Tests', () => {
  describe('WebNotification Management Component', () => {
    let comp: WebNotificationComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(WebNotificationComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.webNotifications && comp.webNotifications[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
